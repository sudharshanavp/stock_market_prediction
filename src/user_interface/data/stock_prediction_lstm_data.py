...
def fit_scalar_object(
    ...
    # Fit x_train values
    x_train_scaler.fit_transform(train_values)

    # Fit x_valid values
    x_train_scaler.transform(valid_values)

    # Fit x_test values
    x_train_scaler.transform(test_values)

    return x_train_scaler
